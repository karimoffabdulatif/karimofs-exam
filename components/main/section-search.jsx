    ...
    <div className="bg-white w-full h-[80px]">
        <div className="container mx-auto px-10 max-w-1240">
           ...
           <div className="mt-[13px] flex gap-2">
            ...
            <div className="flex">
            <input type="Search" placeholder="Поиск" className="bg-[#F2F2F2] text-[#1F1D14] w-[580px] h-[54px] rounded-[5px] p-5" />
            <Image src={Search_Icon} alt="Search_Icon"  className="ml-[-40px]"/>
            </div>
            </div>

               <div className="mt-[13px] flex gap-20">

                <div className="flex gap-9 mt-[8px]  ">
                ...
                <button className="bg-[#F2F2F2] w-[165px] h-[53px] rounded-[3px] flex items-center justify-center size-5 mt-[2px] hover:bg-yellow-300 transition-all">
