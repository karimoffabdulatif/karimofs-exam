      ...
      <div className="container mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-6 lg:gap-8">
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 lg:gap-8">
            <button className="hidden lg:flex bg-black p-3 sm:p-4 lg:p-[11px] text-[16px] sm:text-[18px] lg:text-[20px] hover:bg-yellow-300 hover:text-black transition-all gap-2 text-white rounded-[5px] items-center justify-center space-x-2">
          ...
          <div className="flex items-center gap-4 sm:gap-6 lg:gap-8 mt-4 sm:mt-0">
            <div className="flex gap-2 sm:gap-4 lg:gap-6">
              <Login_Modal />
              <Link href='/wishlist' className="bg-[#F2F2F2] w-10 h-10 sm:w-11 sm:h-11 lg:w-12 lg:h-12 rounded-[3px] flex items-center justify-center hover:bg-yellow-300 transition-all">
                <Image src={Like_Icon} alt="Like_Icon" />
              </Link>
            </div>

            <Link href="/basket">
              <button className="bg-[#F2F2F2] w-full sm:w-auto px-4 py-2 sm:px-6 sm:py-3 md:px-6 md:py-3 lg:px-8 lg:py-4 md:w-[165px] lg:w-[200px] rounded-[3px] flex items-center justify-center hover:bg-yellow-300 transition-all">
